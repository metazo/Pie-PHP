...
<div class="container">
        ...
        <form action="#" method="post" autocomplete="off">
            <div class="form-group">
                <input type="text" name="name" id="name" required class="inputField" autocomplete="off">
                <label for="username">Nom</label>
            </div>
            <div class="form-group">
                <input type="email" name="email" id="name" required class="inputField" autocomplete="off">
                <label for="mail">Adresse mail</label>
            </div>
            <div class="form-group">
                <input type="text" name="number" id="number" required class="inputField" autocomplete="off">
    ...
    <option value="1940">1940</option>
        ...
        <div class="footer">
            <a href="#">Mot de passe oublié ?</a>
                <br><br>
            <a href="./login.php">Dèja inscrit ? Connectez-vous</a>
        </div>
    </div>
</html>